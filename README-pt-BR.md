...
### Calculos rápidos (Back-of-the-envelope calculations)

Você pode ser solicitado a fazer algumas estimativas manualmente. Consulte o [Apêndice](#Apêndice) para os seguintes recursos:

* [Use cálculos do verso do envelope](http://highscalability.com/blog/2011/1/26/google-pro-tip-use-back-of-the-envelope-calculations-to-choo.html)
* [Poder de potências de dois](#Poder-de-potências-de-dois)
* [Números de latência que todo programador deve saber](#Números-de-latência-que-todo-programador-deve-saber)
...
**Latência** o tempo para executar alguma ação ou produzir algum resultado.

**Taxa de transferência** é o numero de tais ações ou resultados por unidade de tempo.

Geralmente, você deve ter como objetivo **taxa de transferencia máxima** com **latência aceitável**.
